...
export const problems: Problem[] = [
  ...
  {
    title: "Reducere",
    statement: `For more info about the problem statement visit: <a href="/03Reducere RO.pdf" target="_blank" style="text-decoration: underline;">Reducere</a>`,
    testCases: [
      {
        id: 1,
        name: "Test 1",
        description: "Example 1 from problem – remove 8 and 9",
        input: "8900012 2\n",
        expectedOutput: "12\n",
      },
      {
        id: 2,
        name: "Test 2",
        description: "Example 2 from problem – result is 0",
        input: "34020 3\n",
        expectedOutput: "0\n",
      },
      {
        id: 3,
        name: "Test 3",
        description: "Remove leading digit, result 0 (no leading zeros)",
        input: "10 1\n",
        expectedOutput: "0\n",
      },
      {
        id: 4,
        name: "Test 4",
        description: "Remove all digits, result 0",
        input: "10 2\n",
        expectedOutput: "0\n",
      },
      {
        id: 5,
        name: "Test 5",
        description: "Single digit removed entirely",
        input: "5 1\n",
        expectedOutput: "0\n",
      },
      {
        id: 6,
        name: "Test 6",
        description: "Two digits, remove the larger first",
        input: "21 1\n",
        expectedOutput: "1\n",
      },
      {
        id: 7,
        name: "Test 7",
        description: "100 remove 1 – leading zeros stripped",
        input: "100 1\n",
        expectedOutput: "0\n",
      },
      {
        id: 8,
        name: "Test 8",
        description: "100 remove 2 – result 0",
        input: "100 2\n",
        expectedOutput: "0\n",
      },
      {
        id: 9,
        name: "Test 9",
        description: "112 remove 1 – remove last digit (no drop before it)",
        input: "112 1\n",
        expectedOutput: "11\n",
      },
      {
        id: 10,
        name: "Test 10",
        description: "1231 remove 2 – removes 2 and 3, result 11",
        input: "1231 2\n",
        expectedOutput: "11\n",
      },
      {
        id: 11,
        name: "Test 11",
        description: "10200 remove 1 – removes leading 1, strip zeros",
        input: "10200 1\n",
        expectedOutput: "200\n",
      },
      {
        id: 12,
        name: "Test 12",
        description: "All same digits, remove 5 of 10",
        input: "1111111111 5\n",
        expectedOutput: "11111\n",
      },
      {
        id: 13,
        name: "Test 13",
        description:
          "Fully descending number, remove 5 – removes first 5 large digits",
        input: "9876543210 5\n",
      ...
      },
      {
        id: 14,
        name: "Test 14",
        description: "Remove 9 of 10 digits, one digit remains",
        input: "1234567890 9\n",
        expectedOutput: "0\n",
      },
      {
        id: 15,
        name: "Test 15",
        description: "Max p with 19 nines, remove 1 from end",
        input: "9999999999999999999 1\n",
        expectedOutput: "999999999999999999\n",
      },
      {
        id: 16,
        name: "Test 16",
        description: "Max p with 19 nines, remove all 19 digits",
        input: "9999999999999999999 19\n",
        expectedOutput: "0\n",
      },
      {
        id: 17,
        name: "Test 17",
        description:
          "10^18, remove 1 – removes leading 1, all zeros collapse to 0",
      ...
      },
      {
        id: 18,
        name: "Test 18",
        description: "Large number starting with 9, remove it – result is tiny",
        input: "9000000000000000001 1\n",
        expectedOutput: "1\n",
      },
      {
        id: 19,
        name: "Test 19",
        description:
          "Ascending number, remove 1 – removes last digit (no earlier drop)",
        input: "1111111112 1\n",
        expectedOutput: "111111111\n",
      },
      {
        id: 20,
        name: "Test 20",
        description: "Mixed digits, remove 3 – greedy finds best drops",
        input: "1234509876 3\n",
        expectedOutput: "1209876\n",
      },
    ],
  },
  {
    title: "Spargerea Codului",
    statement: `For more info about the problem statement visit: <a href="/01SpargereaRom.pdf" target="_blank" style="text-decoration: underline;">Spargerea Codului</a>`,
    testCases: [
      {
        id: 1,
        name: "Test 1",
        description: "Example 1 from problem – 3 * 5",
        input: "15\n",
        expectedOutput: "3 5\n",
      },
      {
        id: 2,
        name: "Test 2",
        description: "Example 2 from problem – 2 * 5",
        input: "10\n",
        expectedOutput: "2 5\n",
      },
      {
        id: 3,
        name: "Test 3",
        description: "Example 3 from problem – prime, failed",
        input: "7\n",
      ...
      },
      {
        id: 4,
        name: "Test 4",
        description: "N=1 – no prime factors, failed",
        input: "1\n",
        expectedOutput: "failed\n",
      },
      {
        id: 5,
        name: "Test 5",
        description: "N=2 – prime itself, failed",
        input: "2\n",
        expectedOutput: "failed\n",
      },
      {
        id: 6,
        name: "Test 6",
        description: "N=3 – prime itself, failed",
        input: "3\n",
        expectedOutput: "failed\n",
      },
      {
        id: 7,
        name: "Test 7",
        description: "N=4 = 2*2 – smallest square semiprime",
        input: "4\n",
        expectedOutput: "2 2\n",
      },
      {
        id: 8,
        name: "Test 8",
        description: "N=6 = 2*3 – smallest semiprime with two different primes",
        input: "6\n",
        expectedOutput: "2 3\n",
      },
      {
      ...
      },
      {
        id: 10,
        name: "Test 10",
        description: "N=25 = 5*5 – p squared",
        input: "25\n",
        expectedOutput: "5 5\n",
      },
      {
        id: 11,
        name: "Test 11",
        description: "N=49 = 7*7 – p squared",
        input: "49\n",
        expectedOutput: "7 7\n",
      },
      {
        id: 12,
        name: "Test 12",
        description: "N=35 = 5*7 – two different primes",
        input: "35\n",
        expectedOutput: "5 7\n",
      },
      {
        id: 13,
        name: "Test 13",
        description: "N=77 = 7*11 – two different primes",
        input: "77\n",
        expectedOutput: "7 11\n",
      },
      {
        id: 14,
        name: "Test 14",
        description: "N=12 = 2*2*3 – three prime factors, failed",
        input: "12\n",
        expectedOutput: "failed\n",
      },
      {
        id: 15,
        name: "Test 15",
        description: "N=30 = 2*3*5 – three distinct prime factors, failed",
        input: "30\n",
        expectedOutput: "failed\n",
      },
      {
        id: 16,
        name: "Test 16",
        description: "N=10^12 = 2^12*5^12 – many prime factors, failed",
        input: "1000000000000\n",
        expectedOutput: "failed\n",
      },
      {
        id: 17,
        name: "Test 17",
        description: "N=999999999989 – large prime, failed",
        input: "999999999989\n",
        expectedOutput: "failed\n",
      },
      {
        id: 18,
        name: "Test 18",
        description: "N=1999999874 = 2 * 999999937 – small*large prime",
        input: "1999999874\n",
        expectedOutput: "2 999999937\n",
      },
      {
        id: 19,
        name: "Test 19",
        description:
          "N=999962000357 = 999979 * 999983 – two large primes near 10^6",
        input: "999962000357\n",
        expectedOutput: "999979 999983\n",
      },
      {
        id: 20,
        name: "Test 20",
        description:
          "N=999966000289 = 999983^2 – large prime squared near 10^12",
        input: "999966000289\n",
        expectedOutput: "999983 999983\n",
      },
    ],
  },
  {
    title: "Mezeluri",
    statement: `For more info about the problem statement visit: <a href="/2MezeluriRom.pdf" target="_blank" style="text-decoration: underline;">Mezeluri</a>`,
    testCases: [
      {
        id: 1,
        name: "Test 1",
        description:
          "Given example 1 – minimum subarray of length 4 with sum >= 7",
        input: "6 7\n1 3 1 2 1 3\n",
        expectedOutput: "4\n",
      },
      {
        ...
        name: "Test 2",
        description:
          "Given example 2 – total sum (5) < M (6), impossible → N+1",
        input: "5 6\n1 1 1 1 1\n",
        expectedOutput: "6\n",
      },
      {
        id: 3,
        name: "Test 3",
        description: "N=1, M=1 – single element exactly meets requirement",
        input: "1 1\n1\n",
        expectedOutput: "1\n",
      },
      {
        ...
        name: "Test 4",
        description:
          "N=1, M=1000000 – single element at max weight equals M exactly",
        input: "1 1000000\n1000000\n",
        expectedOutput: "1\n",
      },
      {
        ...
        name: "Test 5",
        description:
          "N=1, M=1000000 – single element one below M, impossible → N+1=2",
        input: "1 1000000\n999999\n",
        expectedOutput: "2\n",
      },
      {
        ...
        name: "Test 6",
        description:
          "N=1000 all ones, M=1 – answer is 1 (any single element suffices)",
        input: "1000 1\n" + "1 ".repeat(1000).trim() + "\n",
        expectedOutput: "1\n",
      },
      {
        ...
        name: "Test 7",
        description:
          "N=5, all equal weights, M equals total sum exactly – entire array needed",
        input: "5 15\n3 3 3 3 3\n",
        expectedOutput: "5\n",
      },
      {
        ...
        name: "Test 8",
        description:
          "N=5, all equal weights, M one above total sum – impossible → N+1=6",
        input: "5 16\n3 3 3 3 3\n",
        expectedOutput: "6\n",
      },
      {
        ...
        name: "Test 9",
        description:
          "N=4, large spike at index 2 – optimal window of length 2 ([1,9])",
        input: "4 10\n1 9 1 1\n",
        expectedOutput: "2\n",
      },
      {
        ...
        name: "Test 10",
        description:
          "N=6, increasing weights, M=100 – last two elements (50+60) satisfy in length 2",
        input: "6 100\n10 20 30 40 50 60\n",
        expectedOutput: "2\n",
      },
      {
        ...
        name: "Test 11",
        description:
          "N=5, all max weight (1000000), M=1 – any single element suffices",
      ...
      },
      {
        ...
        name: "Test 12",
        description:
          "N=10, all max weight (1000000), M=2000000000 – total sum 10^7 < 2*10^9, impossible → 11",
        input:
      ...
      },
      {
        ...
        name: "Test 13",
        description:
          "N=3, M=5, all weights=2 – need all 3 elements (2+2+2=6 >= 5)",
        input: "3 5\n2 2 2\n",
        expectedOutput: "3\n",
      },
      {
        id: 14,
        name: "Test 14",
        description: "N=7, M=7, last element equals M exactly – answer is 1",
        input: "7 7\n1 2 3 4 5 6 7\n",
        expectedOutput: "1\n",
      },
      {
        ...
        name: "Test 15",
        description:
          "N=1000, all max weight (1000000), M=2*10^9 – total sum 10^9 < M, impossible → 1001",
        input: "1000 2000000000\n" + "1000000 ".repeat(1000).trim() + "\n",
        expectedOutput: "1001\n",
      },
      {
        id: 16,
        name: "Test 16",
        description:
          "N=5, all weights=4, M=9 – two elements sum to 8 (too little), need 3",
        input: "5 9\n4 4 4 4 4\n",
        expectedOutput: "3\n",
      },
      {
        ...
        name: "Test 17",
        description:
          "N=4, M=1 – first element is 1000000, any single element satisfies M=1",
        input: "4 1\n1000000 1 1 1000000\n",
        expectedOutput: "1\n",
      },
      {
        ...
        name: "Test 18",
        description:
          "N=6, M=6, last element equals M – answer is 1 (the element 6 alone)",
        input: "6 6\n1 2 3 4 5 6\n",
        expectedOutput: "1\n",
      },
      {
        ...
        name: "Test 19",
        description:
          "N=5, mixed weights with spike at index 4 (value 7) – best window [5,2,7] of length 3",
        input: "5 14\n3 5 2 7 1\n",
        expectedOutput: "3\n",
      },
      {
        ...
        name: "Test 20",
        description:
          "N=8, M=20, single large spike (10) mid-array – optimal 4-element window [3,10,4,5] or similar",
        input: "8 20\n1 2 3 10 4 5 6 7\n",
        expectedOutput: "4\n",
      },
    ],
